%%
% This code takes the image quality metric values for each dataset (between blurred and reference) and compare the two dataset by plotting the avergae of metrics against each other 
close all; clear; clc;
...
% Outputs
% Reference
folder = 'Optical Aberration Dataset/ReferenceVSBlurred';
...
%%
% Metrics that have a different range
