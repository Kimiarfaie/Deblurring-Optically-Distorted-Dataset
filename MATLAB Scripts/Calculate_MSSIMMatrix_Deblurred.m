%% Analyze the image quality of deblurred images using MSSIM metric
% This code calcultes the MSSIM between every possible pair of Deblurred images for a certain method

close all; clear; clc;
% Path to the deblurred images
addpath(genpath('../Metrics'));
deblurred_folder = 'Optical Aberration Dataset/DRBNet/Deblurred Images';
output_folder = 'Optical Aberration Dataset/DRBNet';
